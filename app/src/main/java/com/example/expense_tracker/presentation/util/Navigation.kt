package com.example.expense_tracker.presentation.util
...
import com.example.expense_tracker.presentation.add_edit_transaction.AddEditTransaction
import com.example.expense_tracker.presentation.dashboard.Dashboard
import com.example.expense_tracker.presentation.transaction_details.TransactionDetails
import com.example.expense_tracker.presentation.transactions.Transactions
        ...
        BottomNavigationItem(
            icon =
            {
                Icon(
                    ...
                    contentDescription = stringResource(com.example.expense_tracker.R.string.dashboard),
                )
            },
            label = {
                Text(text = "Dashboard")
        ...
        BottomNavigationItem(
            icon =
            {
                Icon(
                    ...
                    contentDescription = stringResource(com.example.expense_tracker.R.string.transactions),
                )
            },
            label = {
